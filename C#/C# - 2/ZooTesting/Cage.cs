...
namespace ZooTesting
{
    class Cage
    {
        ...
        public Cage(int id, string name, int height, int width, int length, float latitude, float longitude, int doors, int people, int animalLimit, bool open, bool humanInside, bool exhibitInside)
        {
            _id = id;
            _name = name;
            _height = height;
        ...
        {
            get { return _numOfAnimal; }
            set { _numOfAnimal = value; }
        }
        ...
        public void Update()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "UPDATE cage_tb "
                    + "SET name=@Name,size_height=@Height, size_width=@Width, size_length=@Length, location_latitude=@Latitude, location_longitude=@Longitude, doors=@Door, animal_limit=@Animal, people_limit=@People, isopen=@Open, human_inside=@HumanInside, exhibit_inside=@ExhibitInside"
                    + " WHERE ID_cage=" + Id;
                ...
                cmd.Parameters.AddWithValue("@Animal", NumberOfAnimal);
        ...
        public void Add()
        {
            ...
            {
                MySqlCommand cmd = connection.CreateCommand();
                cmd.CommandText = "INSERT INTO cage_tb(name, size_height, size_width, size_length, location_latitude, location_longitude, doors, animal_limit, people_limit, isopen, human_inside, exhibit_inside) "
                + "VALUES(@Name, @Height, @Width, @Length, @Latitude, @Longitude, @Door, @Animal, @People, @Open, @HumanInside, @ExhibitInside)";
                cmd.Parameters.AddWithValue("@Name", Name);
                cmd.Parameters.AddWithValue("@Height", Height);
                cmd.Parameters.AddWithValue("@Width", Width);
                cmd.Parameters.AddWithValue("@Length", Length);
